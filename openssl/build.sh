...
deepstate-afl --compile_test test_heartbleed.cpp --compiler_args="libssl_1_0_1f.a libcrypto_1_0_1f.a -lgpg-error" --out_test_name "$WORKSPACE"/"$test"

printf "\nBuilding test_heartbleed.cpp with Angora\n"
deepstate-angora --compile_test test_heartbleed.cpp --compiler_args="libssl_1_0_1f.a libcrypto_1_0_1f.a -lgpg-error" --out_test_name "$WORKSPACE"/"$test" \
